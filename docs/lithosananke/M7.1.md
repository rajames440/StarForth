...
>
> No INIT is shared implicitly.
> No base INIT exists.
> Any similarity between VMs is the result of deliberate reuse by Mama.
...
4. INIT blocks are **copied** into the VM execution window (RAM blocks 0–2047)
