...
**⚠️ Warning:** Only use for production code that has been thoroughly tested. Stack overflows may go undetected.
...
**Result:** ~7-8x faster than debug build, ~1.2-1.5x faster than standard `-O3`
