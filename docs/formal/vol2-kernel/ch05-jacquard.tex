...
\begin{table}[ht]
  ...
  \begin{tabular}{ll}
    ...
    \midrule
    \texttt{stable}     & %% TODO(bob): describe stable mode attractor profile \\
    \texttt{volatile}   & %% TODO(bob): describe volatile mode \\
    \texttt{diverse}    & %% TODO(bob): describe diverse mode \\
    \texttt{temporal}   & %% TODO(bob): describe temporal mode \\
    \texttt{transition} & %% TODO(bob): describe transition mode \\
    \texttt{omni}       & %% TODO(bob): describe omni mode \\
    \bottomrule
  \end{tabular}
\end{table}
