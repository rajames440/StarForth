...
No filesystem touches: the VM retains inference state in RAM and can grow its minimal heap if needed to cache priors/posteriors between maintenance cycles.
