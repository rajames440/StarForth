<!-- Moved from docs/AI_AGENT_MANDATORY_README.md to docs/working/scratch/AI_AGENT_MANDATORY_README.md on 2026-06-16 (docs reorg Phase 2) -->
...
Every subsystem is a **feedback loop** interacting with other loops.
Ignorant changes WILL break the system.
