// Moved from docs/src/internal/GOVERNANCE_EXPORT_NOTES.adoc to docs/working/scratch/src/internal/GOVERNANCE_EXPORT_NOTES.adoc on 2026-06-16 (docs reorg Phase 2)
