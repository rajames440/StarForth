// Moved from docs/src/internal/PHYSICS_HOTWORDS_CACHE_INTEGRATION.adoc to docs/working/scratch/src/internal/PHYSICS_HOTWORDS_CACHE_INTEGRATION.adoc on 2026-06-16 (docs reorg Phase 2)
