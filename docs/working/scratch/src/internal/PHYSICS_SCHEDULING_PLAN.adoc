// Moved from docs/src/internal/PHYSICS_SCHEDULING_PLAN.adoc to docs/working/scratch/src/internal/PHYSICS_SCHEDULING_PLAN.adoc on 2026-06-16 (docs reorg Phase 2)
