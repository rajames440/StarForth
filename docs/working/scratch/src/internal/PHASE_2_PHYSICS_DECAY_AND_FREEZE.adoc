// Moved from docs/src/internal/PHASE_2_PHYSICS_DECAY_AND_FREEZE.adoc to docs/working/scratch/src/internal/PHASE_2_PHYSICS_DECAY_AND_FREEZE.adoc on 2026-06-16 (docs reorg Phase 2)
