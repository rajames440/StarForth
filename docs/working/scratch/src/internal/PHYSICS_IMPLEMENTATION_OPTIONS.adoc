// Moved from docs/src/internal/PHYSICS_IMPLEMENTATION_OPTIONS.adoc to docs/working/scratch/src/internal/PHYSICS_IMPLEMENTATION_OPTIONS.adoc on 2026-06-16 (docs reorg Phase 2)
