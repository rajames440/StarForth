// Moved from docs/src/build-and-tooling/PLATFORM_BUILD_GUIDE.adoc to docs/working/scratch/src/build-and-tooling/PLATFORM_BUILD_GUIDE.adoc on 2026-06-16 (docs reorg Phase 2)
