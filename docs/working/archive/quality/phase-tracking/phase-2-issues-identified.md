<!-- Moved from docs/04-quality/phase-tracking/phase-2-issues-identified.md to docs/working/archive/quality/phase-tracking/phase-2-issues-identified.md on 2026-06-16 (docs reorg Phase 2) -->
