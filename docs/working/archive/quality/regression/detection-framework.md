<!-- Moved from docs/04-quality/regression/detection-framework.md to docs/working/archive/quality/regression/detection-framework.md on 2026-06-16 (docs reorg Phase 2) -->
