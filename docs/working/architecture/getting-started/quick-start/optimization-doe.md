<!-- Moved from docs/01-getting-started/quick-start/optimization-doe.md to docs/working/architecture/getting-started/quick-start/optimization-doe.md on 2026-06-16 (docs reorg Phase 2) -->
