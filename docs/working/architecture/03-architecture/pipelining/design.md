<!-- Moved from docs/03-architecture/pipelining/design.md to docs/working/architecture/03-architecture/pipelining/design.md on 2026-06-16 (docs reorg Phase 2) -->
