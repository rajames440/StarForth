<!-- Moved from docs/03-architecture/pipelining/context-window-and-binary-chop.md to docs/working/architecture/03-architecture/pipelining/context-window-and-binary-chop.md on 2026-06-16 (docs reorg Phase 2) -->
