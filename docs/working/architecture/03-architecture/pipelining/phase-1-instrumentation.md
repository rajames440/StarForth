<!-- Moved from docs/03-architecture/pipelining/phase-1-instrumentation.md to docs/working/architecture/03-architecture/pipelining/phase-1-instrumentation.md on 2026-06-16 (docs reorg Phase 2) -->
