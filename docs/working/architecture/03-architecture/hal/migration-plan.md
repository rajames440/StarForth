<!-- Moved from docs/03-architecture/hal/migration-plan.md to docs/working/architecture/03-architecture/hal/migration-plan.md on 2026-06-16 (docs reorg Phase 2) -->
# HAL Migration Plan
...
6. ✅ **Ready for StarKernel** - Platform layer can be replaced
...
1. **Implement StarKernel platform** (`src/platform/kernel/`)
