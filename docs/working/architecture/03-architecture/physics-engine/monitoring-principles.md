<!-- Moved from docs/03-architecture/physics-engine/monitoring-principles.md to docs/working/architecture/03-architecture/physics-engine/monitoring-principles.md on 2026-06-16 (docs reorg Phase 2) -->
