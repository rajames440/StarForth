<!-- Moved from docs/03-architecture/physics-engine/ssm-raw-data-analysis.md to docs/working/architecture/03-architecture/physics-engine/ssm-raw-data-analysis.md on 2026-06-16 (docs reorg Phase 2) -->
