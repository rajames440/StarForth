<!-- Moved from docs/03-architecture/heartbeat-system/instrumentation-plan.md to docs/working/architecture/03-architecture/heartbeat-system/instrumentation-plan.md on 2026-06-16 (docs reorg Phase 2) -->
