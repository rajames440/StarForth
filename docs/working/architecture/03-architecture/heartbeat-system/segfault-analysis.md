<!-- Moved from docs/03-architecture/heartbeat-system/segfault-analysis.md to docs/working/architecture/03-architecture/heartbeat-system/segfault-analysis.md on 2026-06-16 (docs reorg Phase 2) -->
