<!-- Moved from docs/02-experiments/L8_WIRING_CODE_REVIEW_GUIDE.md to docs/working/experiments/02-experiments/L8_WIRING_CODE_REVIEW_GUIDE.md on 2026-06-16 (docs reorg Phase 2) -->
