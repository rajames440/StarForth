<!-- Moved from docs/02-experiments/physics-optimization/reproduce.md to docs/working/experiments/02-experiments/physics-optimization/reproduce.md on 2026-06-16 (docs reorg Phase 2) -->
