<!-- Moved from docs/02-experiments/physics-optimization/hotwords-cache.md to docs/working/experiments/02-experiments/physics-optimization/hotwords-cache.md on 2026-06-16 (docs reorg Phase 2) -->
