<!-- Moved from docs/02-experiments/heartbeat-doe/phase2-corrected.md to docs/working/experiments/02-experiments/heartbeat-doe/phase2-corrected.md on 2026-06-16 (docs reorg Phase 2) -->
