...
if raw_class:
   ...
   """
    ...
    for i in by_heuristic.keys():
        print
        heuristic_define(i, stratdesc)

    if used[0] in by_heuristic.keys():
        print
        "/* Global best, " + used[0] + ", already defined */"
    else:
        print
        "/* Global best (used as a default): */"
        print
        heuristic_define(used[0], stratdesc)
   ...
   """
    ...
    for i in by_heuristic.keys():
        ...
        "   else if("
        print
        translate_class_list(by_heuristic[i]) + ")"
        print
        '''   {
        ...
        print
        parse_control_info(stratdesc[i])
        ...
        print
        parse_ordering_info(stratdesc[i])
        print
        "#endif\n   }"
    ...
    print
    parse_control_info(stratdesc[used[0]])

    print
    '''#endif
   #ifdef TO_ORDERING_INTERNAL'''
    print
    parse_ordering_info(stratdesc[used[0]])
    print
    "#endif\n   }"
