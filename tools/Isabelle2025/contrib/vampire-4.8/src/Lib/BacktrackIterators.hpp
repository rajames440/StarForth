 ...
 */
    ...
    VirtualIterator<State> getBacktrackingIterator(State initState,
        ...
        return VirtualIterator<State>(
            new BacktrackingIterator<State, ChoiceArr, Fn>(initState, choices, chLen, functor));
    }
    ...
    class BtrFnForIterable {
        ...
        public:
            ...
            VirtualIterator<State> operator()(ChoicePoint cp) { return _functor(_state, cp); }
    ...
    VirtualIterator<State> getIteratorBacktrackingOnIterable(State initState,
        ...
        return vi(new BacktrackingIterator<State, ChoiceArr, Fn>(initState, choices, chLen,
                                                                 Fn(innerFunctor)
        ));
    }
