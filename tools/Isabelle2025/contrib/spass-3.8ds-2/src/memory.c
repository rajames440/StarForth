...
***********************************************************/
unsigned int memory_CalculateRealBlockSize(unsigned int 
							     BlockSize)
/**********************************************************
...
unsigned int memory_LookupRealBlockSize(unsigned int 
							  BlockSize)
/**********************************************************
  INPUT  : Size of a block of memory.
  RETURNS: its real size.
...
#ifdef CHECK
void memory_SetBlockStatusAndSize(POINTER Mem, 
						    unsigned int Status,
						    unsigned int Size)
/**********************************************************
...
#ifdef CHECK
  MEMORY_INFO         NewInfo = NULL;          /* Storage for file and line 
					   of allocation */
#endif
