...
typedef enum { flag_SPASS, flag_TPTP2DFG, flag_DFG2TPTP, flag_PGEN, flag_RESCMP, flag_DFG2DFG
} FLAG_USERS;
...
/* State definitions for flag_ISABELLE */
typedef enum {
	       flag_ISABELLEMIN = -1,
	       flag_ISABELLEOFF = flag_OFF,
	       flag_ISABELLEON  = flag_ON,
	       flag_ISABELLEUNSOUND = 2,
//TODO sortcheck	       flag_ISABELLEUNSORTCHECK = 3,
	       flag_ISABELLEMAX
} FLAG_ISABELLE;


/* State definitions for flag_HEURISTOC */
typedef enum {
	       flag_HEURISTICMIN = -1,
	       flag_HEURISTICOFF = 0,
	       flag_HEURISTICGOAL  = 1,
	       flag_HEURISTICRANK  = 2,
	       flag_HEURISTICMAX
} FLAG_HEURISTIC;

/* State definitions for flag_DepthMax */
typedef enum { flag_DEPTHMAXMIN = 0,
	       flag_DEPTHMAXMAX = INT_MAX
} FLAG_DEPTHMAX;

/* State definitions for flag_DepthConjMax */
typedef enum { flag_DEPTHCONJMAXMIN = -1,
	       flag_DEPTHCONJMAXMAX = INT_MAX
} FLAG_DEPTHCONJMAX;
...
typedef enum { flag_CNFPROOFSTEPSMIN = -1,
...
/* State definitions for flag_LIGHTDOCPROOF */
typedef enum { flag_LIGHTDOCPROOFMIN = -1,
	       flag_LIGHTDOCPROOFOFF = flag_OFF,
	       flag_LIGHTDOCPROOFON  = flag_ON,
	       flag_LIGHTDOCPROOFMAX
} FLAG_LIGHTDOCPROOFTYPE;
...
/* State definitions for flag_FPFCR */
typedef enum { flag_FPFCRMIN = -1,
               flag_FPFCROFF = flag_OFF,
               flag_FPFCRON  = flag_ON,
               flag_FPFCRMAX
} FLAG_FPFCRTYPE;
...
/* State definitions for flag_Transitivity */
typedef enum { flag_TRANSMIN = -1,
               flag_TRANSOFF = flag_OFF,
               flag_TRANSON  = flag_ON,
               flag_TRANSMAX
} FLAG_TRANSTYPE;

/* State definitions for flag_IChain */
typedef enum { flag_CHAININGMIN = -1,
               flag_CHAININGOFF = flag_OFF,
               flag_CHAININGON  = flag_ON,
               flag_CHAININGMAX
} FLAG_CHAININGTYPE;

/* State definitions for flag_ICompRes */
typedef enum { flag_COMPOSITIONRESOLUTIONMIN = -1,
               flag_COMPOSITIONRESOLUTIONOFF = flag_OFF,
               flag_COMPOSITIONRESOLUTIONON  = flag_ON,
               flag_COMPOSITIONRESOLUTIONMAX
} FLAG_COMPOSITIONRESOLUTIONTYPE;

/* State definitions for flag_TransWeight */
typedef enum { flag_TRANSWEIGHTMIN = -1,
               flag_TRANSWEIGHTDEFAULT = 6,
               flag_TRANSWEIGHTMAX = INT_MAX
} FLAG_TRANSWEIGHTTYPE;
...
/* State definitions for flag_RFMRR */
typedef enum { flag_RNUVMIN = -1,
               flag_RNUVOFF = flag_OFF,
               flag_RNUVON  = flag_ON,
               flag_RNUVMAX
} FLAG_NUVTYPE;
...
typedef enum { flag_AUTO, flag_STDIN, flag_INTERACTIVE, flag_FLOTTER,
	       ...
	       flag_DepthMax, flag_DepthConjMax, flag_LR, flag_LT, flag_ISABELLE,flag_HEURISTIC,

               flag_SPLITS,     flag_SPLITMININST,
	       flag_MEMORY,     flag_TIMELIMIT,
	       flag_DOCSST,     flag_DOCPROOF, flag_LIGHTDOCPROOF,
	       ...
	       flag_PSTATISTIC, flag_FPMODEL,    flag_FPFCR, flag_FPDFGPROOF,
	       ...
	       flag_Transitivity, flag_IChain, flag_ICompRes, flag_TransWeight,
         
	       flag_RFREW,      flag_RBREW,
	       flag_RFMRR,      flag_RBMRR,      flag_RNUV,
...
void              flag_FPrintFlagWithValue(FILE*, FLAGSTORE, FLAG_ID, int, const char *);
