...
/**
 * capsule_loader.h - Block Capsule Loader (M7.1)
 *
 * Parses a capsule payload for "Block <num>" headers and writes each
 * block's content into the correct ramdrive slot.
 *
 * Format:
 *   Block <decimal>\n
 ...
 *
 * @param payload   Raw capsule payload bytes (not necessarily null-terminated)
