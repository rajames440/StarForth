...
/*
 * physics_pipelining_diagnostic_words.h
 *
 * Declarations for pipelining metrics diagnostic words.
 * Phase 1: Display word-to-word transition statistics collected during execution.
 */
...
#endif /* PHYSICS_PIPELINING_DIAGNOSTIC_WORDS_H */
