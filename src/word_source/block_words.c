...
void register_block_words(VM *vm) {
    ...
    register_word(vm, "BLOCK", word_block);
    register_word(vm, "BUFFER", word_buffer);
    register_word(vm, "UPDATE", word_update);
    register_word(vm, "SAVE-BUFFERS", word_save_buffers);
    register_word(vm, "EMPTY-BUFFERS", word_empty_buffers);
    register_word(vm, "FLUSH", word_flush);
    register_word(vm, "LIST", word_list);
    register_word(vm, "LOAD", word_load);
    register_word(vm, "SCR", word_scr);
    register_word(vm, "THRU", word_thru);
    register_word(vm, "-->", word_arrow);
