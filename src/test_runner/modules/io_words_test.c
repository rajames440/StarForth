...
static WordTestSuite io_word_suites[] = {
    ...
    {
        "TYPE", {
            {"basic_string", "HERE S\" Hello\" DUP >R HERE SWAP CMOVE HERE R> TYPE CR", "Should print: Hello", TEST_NORMAL, 0, 1},
            ...
            {"numbers", "HERE S\" 12345\" DUP >R HERE SWAP CMOVE HERE R> TYPE CR", "Should print: 12345", TEST_NORMAL, 0, 1},
    ...
    {
        "COUNT", {
            {"basic", "HERE S\" Test\" DROP C@ HERE 1+ SWAP COUNT . . CR", "Should show length and addr+1", TEST_NORMAL, 0, 1},
